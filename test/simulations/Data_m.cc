...
int DataDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='n' && strcmp(fieldName, "num")==0) return base+4;
...
std::string DataDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return long2string(pp->getNum());
        case 5: return long2string(pp->getTime());
        default: return "";
    }
}
...
bool DataDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setNum(string2long(value)); return true;
        case 5: pp->setTime(string2long(value)); return true;
